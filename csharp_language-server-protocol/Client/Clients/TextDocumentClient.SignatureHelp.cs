...
namespace OmniSharp.Extensions.LanguageServer.Client.Clients
{
    ...
    {
        /// <summary>
        ///     Request SignatureHelp for a symbol location information at the specified document position.
        /// </summary>
        /// <param name="filePath">
        ...
        /// </returns>
        public async Task<SignatureHelp> SignatureHelp(string filePath, int line, int column,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await Client.SendRequest<SignatureHelp>(DocumentNames.SignatureHelp, request, cancellationToken).ConfigureAwait(false);
